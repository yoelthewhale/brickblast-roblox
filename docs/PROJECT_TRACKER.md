...
| Validate Day36.1 immediate spawn view has no giant cylinder obstruction | High | Playtest | Bear / Codex | 2026-08-10 |
| Capture Day36.1 spawn, central player-height, and aerial map screenshots | High | Playtest | Bear / Codex | 2026-08-10 |
| Validate Day36.2 cohesive toy playset foundation and cleaned route | High | Playtest | Bear / Codex | 2026-08-10 |
| Capture Day36.2 spawn, player-height plaza, attraction, and aerial screenshots | High | Playtest | Bear / Codex | 2026-08-10 |
| Validate Day36.3 runtime debris removal and simplified playset silhouette | High | Playtest | Bear / Codex | 2026-08-10 |
| Capture Day36.3 spawn, PLAY ground-level, attraction, and aerial screenshots | High | Playtest | Bear / Codex | 2026-08-10 |
| Validate Day36.4 toybox personality stopping-point build | High | Playtest | Bear / Codex | 2026-08-11 |
| Capture Day36.4 spawn, PLAY ground-level, central attraction, and aerial screenshots | High | Playtest | Bear / Codex | 2026-08-11 |
| Validate Day37 draggable PC puzzle workspace in Studio | High | Playtest | Bear / Codex | 2026-08-12 |
| Capture Day37 default and dragged PC puzzle workspace screenshots | High | Playtest | Bear / Codex | 2026-08-12 |
| Confirm Day37 board and piece controls do not drag the workspace | High | Playtest | Bear / Codex | 2026-08-12 |
...
| Day36 runtime screenshots showed sideways cylinder foundations obstructing spawn | High | Playtest | Codex | 2026-08-10 |
| Day36.2 foundation cohesion requires manual Studio proof because Codex could not capture Play-mode screenshots here | High | Playtest | Bear / Codex | 2026-08-10 |
| Day36.3 debris removal requires manual Studio proof because Codex could not capture Play-mode screenshots here | High | Playtest | Bear / Codex | 2026-08-10 |
...
| Day37.2.1 board overflow and text contrast fix requires manual Studio proof because Codex could not capture Play-mode screenshots here | High | Playtest | Bear / Codex | 2026-08-12 |
...
- Open `BlockBlastBattle-Day37-2-1.rbxl` in Roblox Studio for the current PC arcade UI layout-fix checkpoint.
...
- Walk off the hub or touch the recovery zone and confirm it returns the player to the safe plaza.
- Confirm no BattleQueuePad, StoryQueuePad, Battle route, Story route, or match arena is visible in the active hub.
- Press the right-side `PLAY` button and confirm the solo puzzle board opens without queueing.
- Use the world `SoloPlayPad` prompt and confirm it starts the same Solo puzzle flow.
- Place a legal piece and confirm score updates.
- Attempt an illegal placement and confirm score does not change.
...
- Capture the Day37.2.1 default, resized-smaller, and resized-larger PC puzzle workspace screenshots listed in `DEVELOPMENT.md`.
- Confirm the Day37.2.1 board shows exactly 64 cells, the tray no longer overlaps, text is readable, and board/piece placement remains functional.
...
- 2026-08-09 Day 32: Cleaned up the real hub composition by reducing/distance-limiting world labels, removing arena/player billboard clutter, hiding the visible recovery plane, reducing repeated debris/particles, enlarging the central island and Brick Core, spacing Battle/Story endpoints, moving arenas farther out, and built `BlockBlastBattle-Day32.rbxl`.
...
## Day32 Visual Review Focus

- Open `BlockBlastBattle-Day32.rbxl` locally and press Play.
- Press F8 during Studio Play mode to hide/show the custom HUD for map inspection.
- Capture a normal spawn-view screenshot facing the Brick Core.
- Capture a plaza view facing the Battle entrance.
- Capture a plaza view facing the Story entrance.
- Capture a three-quarter aerial screenshot.
- Capture an extreme aerial diagnostic screenshot for label overlap only.
- Confirm giant overlapping world text no longer dominates the view.
- Confirm the giant translucent square is no longer visible.
...
- Confirm Studio Output does not show hub fallback warnings.
