...
- Open `BlockBlastBattle-Day36-1.rbxl` in Roblox Studio for the current runtime map/spawn checkpoint.
...
- Capture the Day36.1 spawn, player-height, and aerial screenshots listed in `DEVELOPMENT.md`.
